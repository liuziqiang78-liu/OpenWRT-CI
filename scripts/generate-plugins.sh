...
create_plugin "Nikki" "luci-app-nikki" "Mihomo 透明代理" "Transparent Proxy、高性能、规则分流" "proxy" "https://github.com/nikkinikki-org/OpenWrt-nikki.git"
create_plugin "Xray" "luci-app-xray" "Xray 代理" "VLESS/Vmess/XTLS/Reality" "proxy" "https://github.com/sbwml/luci-app-xray.git"
create_plugin "NeKoBox" "luci-app-nekobox" "NekoBox 客户端" "Neko 核心、多协议" "proxy" "https://github.com/Thaolga/openwrt-nekobox.git"
...
create_plugin "Samba4" "luci-app-samba4" "文件共享" "SMB/CIFS 共享" "storage" "https://github.com/sbwml/luci.git"
...
create_plugin "OpenList2" "luci-app-openlist2" "文件列表" "多存储支持" "storage" "https://github.com/sbwml/luci-app-openlist2.git"
...
create_plugin "ZeroTier" "luci-app-zerotier" "内网穿透" "虚拟局域网" "network" "https://github.com/sbwml/openwrt_pkgs.git"
create_plugin "FRPC" "luci-app-frpc" "FRP 客户端" "内网穿透" "network" "https://github.com/sbwml/luci.git"
create_plugin "FRPS" "luci-app-frps" "FRP 服务端" "FRP 管理" "network" "https://github.com/sbwml/luci.git"
...
create_plugin "SmartDNS" "luci-app-smartdns" "智能 DNS" "多上游 DNS" "network" "https://github.com/sbwml/luci.git"
...
create_plugin "AdGuardHome" "luci-app-adguardhome" "ADG 去广告" "DNS 去广告" "network" "https://github.com/sbwml/openwrt_pkgs.git"
...
create_plugin "BandiX" "luci-app-bandix" "流量监控" "实时流量" "network" "https://github.com/timsaya/luci-app-bandix.git"
...
create_plugin "QoS" "luci-app-qosmate" "流量控制" "带宽管理" "network" "https://github.com/hudra0/luci-app-qosmate.git"
...
create_plugin "Alpha" "luci-theme-alpha" "Alpha 主题" "简洁风格" "theme" "https://github.com/derisamedia/luci-theme-alpha.git"
