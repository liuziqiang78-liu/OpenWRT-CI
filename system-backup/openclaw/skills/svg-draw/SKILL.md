...
3. **Convert to PNG**
   ```bash
   /root/.openclaw/skills/svg-draw/scripts/svg_to_png.sh input.svg output.png 400 400
   ```
...
```bash
/root/.openclaw/skills/svg-draw/scripts/svg_to_png.sh <input.svg> <output.png> [width] [height]
```
...
**Example:**
```bash
/root/.openclaw/skills/svg-draw/scripts/svg_to_png.sh dragon.svg dragon.png 512 512
```
